...
class Peminjaman extends CI_Controller {
    ...
    public function get_peminjaman_all($start, $end){
        ...
        if($method != 'GET'){
            ...
            $resp = $this->Peminjaman_model->get_peminjaman_all($start, $end);
    ...
    public function get_peminjaman_total(){
        ...
        if($method != 'GET'){
            ...
            $resp = $this->Peminjaman_model->get_peminjaman_total($search);
    ...
    public function get_peminjaman_filter(){
        ...
        if($method != 'GET'){
            ...
            $resp = $this->Peminjaman_model->get_peminjaman_filter($search, $start, $end);
